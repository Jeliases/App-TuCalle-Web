  ...
  return (
    <div className="flex h-screen w-full bg-white font-poppins overflow-hidden">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-black">
        {/* Reemplaza la URL de abajo con la de tu calle/Cusco si la tienes en Firebase Storage */}
        <img 
      ...
      {/* ── LADO DERECHO (BOTONES DE ACCESO) ── */}
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8">
        <div className="w-full max-w-sm flex flex-col items-center">
          
          <h2 className="font-roboto font-black text-[28px] text-black mb-1">Bienvenido</h2>
          <p className="text-gray-400 text-[13px] mb-10">Inicia sesión para continuar</p>
          ...
          <div className="w-full flex items-center gap-4 my-6">
            ...
            <span className="text-gray-400 text-[10px] uppercase">O</span>
            <div className="flex-1 h-px bg-gray-200"></div>
          </div>

          {/* Botón Gmail */}
          <button 
            className="w-full h-[52px] bg-white border border-gray-200 text-gray-700 font-bold rounded-full flex items-center justify-center gap-3 hover:bg-gray-50 transition-colors cursor-pointer shadow-sm"
          >
            {/* Ícono Oficial de Google/Gmail en SVG */}
